...
const T = {
  ...
  'istr.01.body':  { it: "La biancheria è fornita e già preparata al vostro arrivo. Ulteriori lenzuola pulite di ricambio si trovano nell'armadio bianco ma vanno richieste se necessario. Per cambiarle, contattate i proprietari con almeno 8 ore di anticipo.", en: 'Bed linen is provided and already made up on arrival. Extra clean sheets are in the white wardrobe but must be requested if needed. To change them, contact the owners at least 8 hours in advance.', de: 'Bettwäsche ist vorhanden und bei Ihrer Ankunft bereits bezogen. Weitere saubere Laken befinden sich im weißen Schrank, müssen aber angefordert werden. Kontaktieren Sie die Eigentümer mindestens 8 Stunden im Voraus.', fr: "Le linge de lit est fourni et déjà préparé à votre arrivée. Des draps supplémentaires propres se trouvent dans l'armoire blanche mais doivent être demandés. Contactez les propriétaires au moins 8 heures à l'avance." },
